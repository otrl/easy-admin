...
var defaults = {
    ...
    messages: new _immutable.Map({
        ...
        NAVIGATION_CARDHOLDERS: 'Cardholders',
        NAVIGATION_ACCOUNT: 'My account',
        NAVIGATION_ACTION_LOG: 'Action log',
        NAVIGATION_CUSTOMERS: 'Customers',
        CARDHOLDERS_SEARCH_FORM_FIRST_NAME_FIELD_LABEL: 'First name',
        CARDHOLDERS_SEARCH_FORM_FIRST_NAME_FIELD_INVALID_FORMAT: 'First name must be minimum 3 characters and max 255!',
        CARDHOLDERS_SEARCH_FORM_LAST_NAME_FIELD_LABEL: 'Last name',
        CARDHOLDERS_SEARCH_FORM_LAST_NAME_FIELD_INVALID_FORMAT: 'Last name must be minimum 3 characters and max 255!',
        CARDHOLDERS_POSTCODE_NAME_FIELD_LABEL: 'Post code',
        CARDHOLDERS_SEARCH_FORM_POSTCODE_FIELD_INVALID_FORMAT: 'Postcode must be minimum 3 characters and max 10!',
        CARDHOLDERS_SEARCH_FORM_SUBMIT: 'Search',
        CARDHOLDERS_LISTING_TITLE: 'Cardholders',
        CARDHOLDERS_LISTING_BREADCRUMB: 'Cardholders',
        CARDHOLDERS_LISTING_TABLE_NAME_COL: 'Name',
        CARDHOLDERS_LISTING_TABLE_POSTCODE_COL: 'Postcode',
        CARDHOLDERS_LISTING_EDIT_BUTTON: 'View/edit customer',
        ...
        CUSTOMERS_SEARCH_FORM_FIRST_NAME_FIELD_LABEL: 'First name',
        CUSTOMERS_SEARCH_FORM_FIRST_NAME_FIELD_INVALID_FORMAT: 'First name must be minimum 3 characters and max 255!',
        CUSTOMERS_SEARCH_FORM_LAST_NAME_FIELD_LABEL: 'Last name',
        CUSTOMERS_SEARCH_FORM_LAST_NAME_FIELD_INVALID_FORMAT: 'Last name must be minimum 3 characters and max 255!',
        CUSTOMERS_POSTCODE_NAME_FIELD_LABEL: 'Post code',
        CUSTOMERS_SEARCH_FORM_POSTCODE_FIELD_INVALID_FORMAT: 'Postcode must be minimum 3 characters and max 10!',
        CUSTOMERS_SEARCH_FORM_SUBMIT: 'Search',
        CUSTOMERS_LISTING_TABLE_NAME_COL: 'Name',
        CUSTOMERS_LISTING_TABLE_ISRN_COL: 'ISRN',
        CUSTOMERS_LISTING_TABLE_POSTCODE_COL: 'Postcode',
        CUSTOMERS_LISTING_TABLE_STATUS_COL: 'Status',
        CUSTOMERS_LISTING_TITLE: 'Customers',
        CUSTOMERS_LISTING_BREADCRUMB: 'Customers',
        SMARTCARD_TITLE: 'Smartcard: {isrn}',
        SMARTCARD_BREADCRUMB: 'Smartcard',
