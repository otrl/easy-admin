...
var PasswordResetRequest = function (_React$PureComponent) {
    (0, _inherits3.default)(PasswordResetRequest, _React$PureComponent);
    ...
    function PasswordResetRequest() {
        ...
        (0, _classCallCheck3.default)(this, PasswordResetRequest);
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.state = {
            ...
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(e) {
                var _this$props, form, history, dictionary;
                ...
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                e.preventDefault();
                                _this$props = _this.props, form = _this$props.form, history = _this$props.history, dictionary = _this$props.dictionary;
                                            ...
                                            while (1) {
                                                switch (_context.prev = _context.next) {
                                                    case 0:
                                                        ...
                                                        _context.prev = 1;
                                                        _context.next = 4;
                                                        return _this.props.passwordResetRequest(values.email);
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'title',
                    null,
                    dictionary.getByKey("PASSWORD_RESET_REQUEST_PAGE_TITLE")
                )
            ),
            _react2.default.createElement(
                _antd.Row,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                getFieldDecorator('email', {
                                    rules: [{ required: true, message: dictionary.getByKey("PASSWORD_RESET_REQUEST_EMAIL_REQUIRED") }, { type: "email", message: dictionary.getByKey("PASSWORD_RESET_REQUEST_EMAIL_INVALID_FORMAT") }]
                            ...
                            _react2.default.createElement(
                                ...
                                dictionary.getByKey("PASSWORD_RESET_REQUEST_BACK_LINK")
                            )
                        )
                    )
                )
...
PasswordResetRequest.propTypes = {
    ...
    passwordResetRequest: _propTypes2.default.func.isRequired,
...
var dispatchToProps = function dispatchToProps(dispatch) {
    return {
        passwordResetRequest: (0, _redux.bindActionCreators)(_PasswordResetActions2.default.requestPasswordReset, dispatch)
    };
};
...
var WrappedPasswordResetRequest = _antd.Form.create()(PasswordResetRequest);

exports.default = (0, _reactRedux.connect)(getStoresMap, dispatchToProps)(WrappedPasswordResetRequest);
