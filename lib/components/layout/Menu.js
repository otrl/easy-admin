...
function Menu(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            appTree && appTree.map(function (navigationItem) {
                return user.hasPermission(navigationItem.navPermission) && navigationItem.navString && _react2.default.createElement(
                    _antd.Menu.Item,
                    { key: navigationItem.path },
                    _react2.default.createElement(
                        _reactRouterDom.NavLink,
                        { to: navigationItem.path },
                        navigationItem.navIcon && _react2.default.createElement(_antd.Icon, { type: navigationItem.navIcon }),
                        _react2.default.createElement(
                            'span',
                            null,
                            dictionary.getByKey(navigationItem.navString)
                        )
                    )
                );
            })
