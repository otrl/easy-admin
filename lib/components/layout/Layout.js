...
var Layout = function (_React$PureComponent) {
    ...
    Layout.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            ui = _props.ui,
            homePageComponent = _props.homePageComponent,
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        appTree && appTree.map(function (page) {
                            return _react2.default.createElement(_AuthorisedRoute2.default, { path: page.path,
                                key: page.path,
                                user: user,
                                permission: page.permission,
                                setPathMatch: _this2.setPathMatch(page.pathMatches),
                                component: page.pageComponent });
                        }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: _constants.Urls.LOGOUT,
                            component: _logout2.default }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: _constants.Urls.HOME,
...
Layout.propTypes = {
    ...
    appTree: _propTypes2.default.array
};
